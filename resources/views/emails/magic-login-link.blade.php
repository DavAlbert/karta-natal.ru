...
<body style="margin: 0; padding: 0; background-color: #0f0f23; font-family: Arial, Helvetica, sans-serif; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden; mso-hide: all;">
        {{ __('emails.magic_login_text') }}&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;
    </div>
                            ...
                            <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="email-content" style="padding: 32px 40px 36px 40px;">
                                        <p style="margin: 0 0 6px 0; font-size: 17px; line-height: 1.5; color: #e8e8f0; font-weight: 700;">{{ __('emails.magic_login_greeting', ['name' => $user->name ?? '']) }}</p>
                                        <p style="margin: 0 0 28px 0; font-size: 15px; line-height: 1.7; color: #a8a8c8;">{{ __('emails.magic_login_text') }}</p>
                                        ...
                                        <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td align="center">
                                                    <!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ route('magic.login.token', $token) }}" style="height:48px;v-text-anchor:middle;width:220px;" arcsize="10%" strokecolor="#d4af37" fillcolor="#d4af37">
                                                    <w:anchorlock/>
                                                    <center style="color:#1a1a2e;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:bold;">{{ __('emails.magic_login_button') }}</center>
                                                    </v:roundrect>
                                                    <![endif]-->
                                                    <!--[if !mso]><!-->
                                                    <table role="presentation" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="btn-td" style="border-radius: 6px; background-color: #d4af37;">
                                                                <a href="{{ route('magic.login.token', $token) }}" target="_blank" style="display: inline-block; padding: 14px 36px; color: #1a1a2e; text-decoration: none; font-size: 15px; font-weight: 700; font-family: Arial, Helvetica, sans-serif; border-radius: 6px; mso-padding-alt: 0;">{{ __('emails.magic_login_button') }}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!--<![endif]-->
                                        ...
                                        <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top: 28px;">
                                            <tr>
                                                <td style="border-top: 1px solid #2a2a5e; padding-top: 20px;">
                                                    <p style="margin: 0 0 4px 0; font-size: 13px; line-height: 1.6; color: #6a6a8a;">{{ __('emails.magic_login_expires') }}</p>
                                                    <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #6a6a8a;">{{ __('emails.magic_login_ignore') }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="email-footer" align="center" style="padding: 20px 40px; background-color: #151533; border-top: 1px solid #2a2a5e;">
                                        <p style="margin: 0 0 4px 0; font-size: 12px; color: #6a6a8a; line-height: 1.5;">{{ __('emails.magic_login_footer') }}</p>
